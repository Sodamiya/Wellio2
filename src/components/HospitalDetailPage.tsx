...
import { Progress } from "./ui/progress"; // 👈 Progress 컴포넌트 import
import { Button } from "./ui/button"; // 👈 Button 컴포넌트 import
...
export function HospitalDetailPage({
  ...
  return (
    // [수정] 하단 고정 버튼을 위한 relative, pb-24 추가
    <div className="relative min-h-screen bg-[#F7F7F7] flex flex-col">
      ...
      <main className="flex-1 pb-24 overflow-y-auto">
        ...
        {/* [수정] 병원 정보 카드 (디자인 시안처럼 이미지 위로 올림) */}
        ...
        {/* [수정] 카카오맵 (시안 디자인에 맞게 주소창, 길찾기 버튼 수정) */}
        <div className="mt-6 bg-white py-6">
          <div className="px-4 sm:px-6 md:px-8 mb-4">
            <h3 className="text-lg font-semibold text-gray-900">
              오시는 길
