...
import { Image as ImageIcon, Camera, RefreshCw, ArrowLeft } from "lucide-react"; 
  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen bg-white overflow-hidden">
        ...
        >
          <div 
            // 박스 모양을 위한 실제 카메라 뷰 컨테이너 (좌우 16px 마진)
            className="relative w-[calc(100%-32px)] h-full bg-gray-900 mx-4 rounded-2xl overflow-hidden"
          >
            {/* 카메라 화면 */}
            <video
              ref={videoRef}
